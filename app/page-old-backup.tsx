                ...
                <div className="flex items-center gap-12">
                  ...
                  <div className="flex-1">
                    <div className="animate-fade-in-up mt-3" style={{ animationDelay: "0.2s" }}>
                      <h1 className="font-playfair font-bold text-5xl md:text-6xl text-foreground text-left">
                        Raedan Stephens
                      </h1>
                    </div>

                    <div className="animate-fade-in-up -mt-5 mb-8" style={{ animationDelay: "0.4s" }}>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div>
                    <p className="text-lg leading-relaxed mb-6">
                      ...
                      at Louisiana State University while serving as CEO of Smartective, an AI startup focused on documentation
        ...
        {activeTab === "experience" && (
          <div className="py-20 px-6">
            <div className="max-w-6xl mx-auto">
              ...
              {/* Resume Section */}
              <div className="mt-16">
                <Card className="px-8 pt-8 pb-0 overflow-hidden">
                  <h3 className="font-playfair font-semibold text-2xl text-center mb-4">My Resume</h3>
                  <div className="w-full h-[1050px] flex items-center justify-center overflow-auto -mb-8">
                    <iframe
                      src="/Stephens Resume.pdf"
                      className="w-[125%] h-[1050px] border-0 rounded origin-top"
